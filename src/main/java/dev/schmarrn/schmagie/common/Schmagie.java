...
public class Schmagie implements ModInitializer {
	...
	public static final Item WOODEN_STAFF = new Staff(0, 0, ToolMaterials.WOOD, BlockTags.SHOVEL_MINEABLE, new Item.Settings().group(ItemGroup.MISC));
	...
	private void registerBlock(String name, Block block) {
		...
		registerItem(name, new BlockItem(block, new Item.Settings().group(ItemGroup.MISC)));
	}
